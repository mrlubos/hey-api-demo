...
export class PetStore extends HeyApiClient {
    ...
    public findPetsByTags<ThrowOnError extends boolean = false>(options: Options<FindPetsByTagsData, ThrowOnError>) {
        return (options.client ?? this.client).get<FindPetsByTagsResponses, FindPetsByTagsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/pet/findByTags',
            ...options
        });
    ...
    public deletePet<ThrowOnError extends boolean = false>(options: Options<DeletePetData, ThrowOnError>) {
        return (options.client ?? this.client).delete<DeletePetResponses, DeletePetErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/pet/{petId}',
            ...options
        });
    ...
    public updatePetWithForm<ThrowOnError extends boolean = false>(options: Options<UpdatePetWithFormData, ThrowOnError>) {
        return (options.client ?? this.client).post<UpdatePetWithFormResponses, UpdatePetWithFormErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/pet/{petId}',
            ...options
        });
    ...
    public uploadFile<ThrowOnError extends boolean = false>(options: Options<UploadFileData, ThrowOnError>) {
        return (options.client ?? this.client).post<UploadFileResponses, UploadFileErrors, ThrowOnError>({
            bodySerializer: null,
            security: [{ scheme: 'bearer', type: 'http' }],
     ...
     */
    public getInventory<ThrowOnError extends boolean = false>(options?: Options<GetInventoryData, ThrowOnError>) {
    ...
    public placeOrder<ThrowOnError extends boolean = false>(options?: Options<PlaceOrderData, ThrowOnError>) {
        return (options?.client ?? this.client).post<PlaceOrderResponses, PlaceOrderErrors, ThrowOnError>({
            url: '/store/order',
            ...options,
            headers: {
                'Content-Type': 'application/json',
    ...
    public deleteOrder<ThrowOnError extends boolean = false>(options: Options<DeleteOrderData, ThrowOnError>) {
        return (options.client ?? this.client).delete<DeleteOrderResponses, DeleteOrderErrors, ThrowOnError>({ url: '/store/order/{orderId}', ...options });
    }
    ...
    public getOrderById<ThrowOnError extends boolean = false>(options: Options<GetOrderByIdData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetOrderByIdResponses, GetOrderByIdErrors, ThrowOnError>({ url: '/store/order/{orderId}', ...options });
    }
    ...
    public createUsersWithListInput<ThrowOnError extends boolean = false>(options?: Options<CreateUsersWithListInputData, ThrowOnError>) {
        return (options?.client ?? this.client).post<CreateUsersWithListInputResponses, CreateUsersWithListInputErrors, ThrowOnError>({
    ...
    public loginUser<ThrowOnError extends boolean = false>(options?: Options<LoginUserData, ThrowOnError>) {
        return (options?.client ?? this.client).get<LoginUserResponses, LoginUserErrors, ThrowOnError>({ url: '/user/login', ...options });
    }
     ...
     */
    public logoutUser<ThrowOnError extends boolean = false>(options?: Options<LogoutUserData, ThrowOnError>) {
        return (options?.client ?? this.client).get<LogoutUserResponses, LogoutUserErrors, ThrowOnError>({ url: '/user/logout', ...options });
    }
    ...
    public deleteUser<ThrowOnError extends boolean = false>(options: Options<DeleteUserData, ThrowOnError>) {
        return (options.client ?? this.client).delete<DeleteUserResponses, DeleteUserErrors, ThrowOnError>({ url: '/user/{username}', ...options });
    }
    ...
    public getUserByName<ThrowOnError extends boolean = false>(options: Options<GetUserByNameData, ThrowOnError>) {
        return (options.client ?? this.client).get<GetUserByNameResponses, GetUserByNameErrors, ThrowOnError>({ url: '/user/{username}', ...options });
    }
